###########################################################################
## Makefile generated for component 'Day1_4_4_raspi'. 
## 
## Makefile     : Day1_4_4_raspi.mk
## Generated on : Thu Oct 19 10:19:24 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Day1_4_4_raspi.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Day1_4_4_raspi.elf
...
DEFINES_ = -DMW_PWMBLOCK -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_CAN_BITRATE=500000 -DMW_CAN_ALLOWALLMSGS=1 -DMW_RASPI_ROTARYENCODER
...
%.c.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_pigs.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/raspi/unifiedserver/MW_pigs.c
	$(CC) $(CFLAGS) -o "$@" "$<"


system.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/realtime/targets/raspi/unifiedserver/system.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_RaspiEncoder.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/raspberrypi/src/MW_RaspiEncoder.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Day1_4_4_raspi.c.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/Day1_4_4_raspi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Day1_4_4_raspi_data.c.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/Day1_4_4_raspi_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Day1_4_4_raspi_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
