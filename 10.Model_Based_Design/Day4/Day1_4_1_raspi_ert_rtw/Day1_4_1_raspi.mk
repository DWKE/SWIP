###########################################################################
## Makefile generated for component 'Day1_4_1_raspi'. 
## 
## Makefile     : Day1_4_1_raspi.mk
## Generated on : Wed Oct 18 16:07:34 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Day1_4_1_raspi.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Day1_4_1_raspi.elf
...
DEFINES_STANDARD = -DMODEL=Day1_4_1_raspi -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/Day1_4_1_raspi_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Day1_4_1_raspi_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Day1_4_1_raspi_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Day1_4_1_raspi_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Day1_4_1_raspi.c.o : $(START_DIR)/Day1_4_1_raspi_ert_rtw/Day1_4_1_raspi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Day1_4_1_raspi_data.c.o : $(START_DIR)/Day1_4_1_raspi_ert_rtw/Day1_4_1_raspi_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
