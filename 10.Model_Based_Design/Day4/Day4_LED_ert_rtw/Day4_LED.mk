###########################################################################
## Makefile generated for component 'Day4_LED'. 
## 
## Makefile     : Day4_LED.mk
## Generated on : Tue Oct 17 14:02:09 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Day4_LED.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Day4_LED.elf
...
DEFINES_STANDARD = -DMODEL=Day4_LED -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/Day4_LED_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Day4_LED_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Day4_LED_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Day4_LED_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Day4_LED.c.o : $(START_DIR)/Day4_LED_ert_rtw/Day4_LED.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Day4_LED_data.c.o : $(START_DIR)/Day4_LED_ert_rtw/Day4_LED_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
