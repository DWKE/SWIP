###########################################################################
## Makefile generated for component 'Day1_2_2_raspi'. 
## 
## Makefile     : Day1_2_2_raspi.mk
## Generated on : Wed Oct 18 11:44:00 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Day1_2_2_raspi.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Day1_2_2_raspi.elf
...
DEFINES_STANDARD = -DMODEL=Day1_2_2_raspi -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Day1_2_2_raspi.c.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/Day1_2_2_raspi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Day1_2_2_raspi_data.c.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/Day1_2_2_raspi_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Day1_2_2_raspi_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
