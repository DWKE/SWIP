...
extern void toggleLCDEnable(int eightBits);
extern void sendBitsToLCD(int eightBits, int mode);
extern void initializeLCD();
extern void displayText(const char *stringPointer);
extern void changeLine(int line);