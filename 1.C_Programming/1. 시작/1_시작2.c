...
// 2. 컴파일러(소스 코드를 CPU의 기계어로 번역하는 역활을 수행하는 프로그램)
// => 이식성
...
// => 이식성
//       compile
// A.java -> A.class(ByteCode) <- 가상 머신(VM) Windows / Linux / Mac
// Kotlin
// Scala
// Jython
// JRuby
...
// C# (Microsoft)
// : 언어 독립적이다. => .Net Framework

//                                Mono Project: Linux, Mac
// A.cs => A.obj(ByteCode, IL) <- RunTime(CLR)
// VB
// C++
// F#
// ...