...
struct P_Day3_avoidance_T_ {
  ...
  real_T Memory_InitialCondition;      /* Expression: 0
                                        ...
                                        */
  real_T Constant2_Value_n;            /* Expression: 3*0.1
  ...
  real_T Switch6_Threshold;            /* Expression: 0.8
                                        ...
                                        */
  real_T Gain3_Gain;                   /* Expression: 1/460
