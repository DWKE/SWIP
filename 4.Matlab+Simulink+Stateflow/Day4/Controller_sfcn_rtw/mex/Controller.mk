...
MODEL                   = Controller
MODULES                 = Controller_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\Controller_sf.mexw64
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:Controller_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SYSTEM_LIBS             = /LIBPATH:"C:\Program Files\MATLAB\R2022b\extern\lib\win64\microsoft" libut.lib libfixedpoint.lib libmx.lib libmex.lib
...
Controller_sf.obj : $(START_DIR)\Controller_sfcn_rtw\Controller_sf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Controller_sfcn_rtw\Controller_sf.c
	$(CC) $(CFLAGS) $(START_DIR)\Controller_sfcn_rtw\Controller_sf.c

rtGetInf.obj : $(START_DIR)\Controller_sfcn_rtw\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\Controller_sfcn_rtw\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\Controller_sfcn_rtw\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\Controller_sfcn_rtw\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\Controller_sfcn_rtw\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\Controller_sfcn_rtw\rtGetNaN.c
